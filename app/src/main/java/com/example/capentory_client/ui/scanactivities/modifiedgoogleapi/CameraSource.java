...
// From https://github.com/googlesamples/android-vision/blob/master/visionSamples/barcode-reader/app/src/main/java/com/google/android/gms/samples/vision/barcodereader/ui/camera/CameraSource.java
...
public class CameraSource {
    ...
    // setCurrentRoom close, but not exactly the same values for these.
    ...
    public static class Builder {
         ...
         * Also, we try to setCurrentRoom a preview size which corresponds to the aspect ratio of an
     ...
     * image.
     *
     * @param camera        the camera to setCurrentRoom a preview size from
    ...
    private static SizePair selectSizePair(Camera camera, int desiredWidth, int desiredHeight) {
        ...
        // only way to setCurrentRoom the best size, but it provides a decent tradeoff between using the
     ...
     * second.
     *
     * @param camera            the camera to setCurrentRoom a frames per second range from
    ...
    private int[] selectPreviewFpsRange(Camera camera, float desiredPreviewFps) {
        ...
        // the desired value and the upper and lower bounds of the range.  This may setCurrentRoom a range
